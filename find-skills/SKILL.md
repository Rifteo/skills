...
| `less-noise-attack` | Operate below SOC detection thresholds, passive recon first, minimal footprint, targeted action only. | `auditguard-skills add less-noise-attack` |
...
- Operate below SOC detection thresholds, passive recon first, minimal footprint, targeted action only. → `less-noise-attack`
